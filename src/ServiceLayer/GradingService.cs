...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return _serviceFactory.userService.UserRegistration(email, password);
        }
        ...
        {
            return _serviceFactory.userService.UserLogin(email, password);
        }
        ...
        {
            return _serviceFactory.userService.UserLogOut(email);
        }
        ...
        {
            return _serviceFactory.boardService.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return _serviceFactory.boardService.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return _serviceFactory.boardService.GetColumnName(columnOrdinal);
        }
        ...
        {
            return _serviceFactory.taskService.CreateTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return _serviceFactory.taskService.EditTaskDate(email, boardName, taskId, dueDate);
        }
        ...
        {
            return _serviceFactory.taskService.EditTaskTitle(email, boardName, taskId, title);
        }
        ...
        {
            return _serviceFactory.taskService.EditTaskDesc(email, boardName, taskId, description);
        }
        ...
        {
            return _serviceFactory.boardService.UpdateColumnOfTask(email, boardName, taskId);
        }
        ...
        {
            return _serviceFactory.boardService.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return _serviceFactory.boardService.CreateBoard(email, name);
        }
        ...
        {
            return _serviceFactory.boardService.DeleteBoard(email, name);
        }
        ...
        {
            return _serviceFactory.taskService.TasksInProgress(email);
        }
        ...
        {
            return _serviceFactory.boardService.GetUserBoards(email);
        }
        ...
        {
            return _serviceFactory.boardService.JoinBoard(email, boardID);
        }
        ...
        {
            return _serviceFactory.boardService.LeaveBoard(email, boardID);
        }
        ...
        {
            return _serviceFactory.taskService.AssignUserToTask(email, emailAssignee, columnOrdinal, boardName, taskID);
        }
        ...
        {
            return _serviceFactory.boardService.GetBoardName(boardId);
        }
        ...
        {
            return _serviceFactory.boardService.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
        }
        ...
        {
            return _serviceFactory.DeleteData();
        }
    }
}